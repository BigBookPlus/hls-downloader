...
This project implements **standard HLS AES-128** as described in [RFC 8216](https://datatracker.ietf.org/doc/html/rfc8216) (`#EXT-X-KEY:METHOD=AES-128`). It decrypts MPEG-TS segments with the key and IV from the playlist, then writes a local file.
